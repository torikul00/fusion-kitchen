...
const CustomerReviews = ({heading}) => {
    ...
    return (
        <section className='h-fit max-w-[1450px] mx-auto mt-[80px] lg:mt-[150px] md:px-5' >
            <h3 className='max-w-[80%] mx-auto text-[#1A1A1A] text-2xl md:text-3xl lg:text-5xl font-bold mb-9'>{heading ? heading : `Don't just take it form us`}</h3>
