            ...
            <HeaderContainer>
                ...
                <div className={`h-fit lg:h-[821px] w-full py-10 lg:py-0 text-white flex flex-col lg:flex-row lg:justify-between lg:items-center overflow-hidden`}>
                    <div className="w-full sm:w-3/5 lg:w-2/5 flex flex-col mx-auto">
                        ...
                        <div key={isSticky} className={`${isSticky ? 'px-7 h-[70px] fixed z-[99] top-0 left-0 right-0 w-screen bg-[#1A1A1A] text-white hidden lg:flex gap-5 items-center sticky-nav' : 'mt-6 xl:mt-[74px]'}`}>
                        ...
                        <div className={`${isSticky ? 'block lg:hidden fixed bg-[#1A1A1A] text-white z-[99] top-0 left-0 right-0' : 'hidden'} ${openBussinessType ? 'w-full h-[calc(100vh-54px)]' : 'w-full h-fit'} transition-all`}>
                        ...
                        <div className={`${isSticky ? 'lg:hidden bg-[#1A1A1A] py-2 w-full fixed text-white z-[99] left-0 bottom-0 right-0 flex gap-2 justify-center border-t border-[#d9d9d9] border-opacity-20' : 'hidden'} transition-all`}>
                    ...
                    <div className="hidden w-3/5 sm:w-4/5 lg:w-[50%] xl:w-3/5 h-full lg:flex justify-end items-center xl:items-end">
