            ...
            <section className="py-[150px]">
                ...
                <div>
                    <div className="max-w-[1300px] px-5 mt-[200px] mx-auto">
                        <h1 className="text-[28px] lg:text-[60px] font-bold lg:leading-[70px]">Join 1000s businesses across the world using Fusion to elevate their operations.</h1>
                        <div className="mt-[70px]">
                            <h1 className="text-[28px] lg:text-[60px] font-bold lg:leading-[70px]">Get a quote!</h1>
                        </div>
                    </div>
                </div>
            </section>
